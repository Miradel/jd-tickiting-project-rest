...
public class TaskController {
    ...
    public ResponseEntity<ResponseWrapper> updateTask(@RequestBody TaskDTO taskDTO) throws TicketingProjectException {
        ...
        return ResponseEntity.ok(new ResponseWrapper("Successfully updated the task"));
    ...
    public ResponseEntity<ResponseWrapper> employeeReadAllCompleteTask() throws TicketingProjectException {
